    ...
    <div className="grid grid-cols-1 gap-1 sm:grid-cols-2 lg:grid-cols-2">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
          ...
          <h2
            className="mt-3 font-display text-xl font-semibold leading-tight text-white transition-colors group-hover:text-white/90 sm:text-2xl lg:text-[28px] line-clamp-3"
            style={{ textShadow: '0 2px 8px rgba(0,0,0,0.8)' }}
          >
            {main.title}
          </h2>
          {main.author && main.date && (
            <p className="mt-2 text-xs text-white/80" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.5)' }}>
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 lg:p-5">
            ...
            <h3
              className="mt-2 font-display text-sm font-semibold leading-snug text-white transition-colors group-hover:text-white/90 lg:text-base line-clamp-2"
              style={{ textShadow: '0 2px 6px rgba(0,0,0,0.7)' }}
            >
              {topRight.title}
            </h3>
            {topRight.date && (
              <p className="mt-1 text-xs text-white/80" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.5)' }}>{topRight.date}</p>
            )}
          </div>
        </Link>
        ...
        <div className="grid grid-cols-2 gap-1">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3">
              ...
              <h3
                className="mt-1 font-display text-xs font-semibold leading-snug text-white transition-colors group-hover:text-white/90 lg:text-sm line-clamp-2"
                style={{ textShadow: '0 2px 6px rgba(0,0,0,0.7)' }}
              >
                {bottomLeft.title}
              </h3>
