  ...
  return (
    <main className="mx-auto w-full max-w-screen-2xl px-6 py-10">
      <header className="mb-8 border-b border-(--border-subtle) pb-6">
        ...
        <p className="mt-1 text-sm text-(--fg-muted)">Buy and sell in your local community</p>
      </header>
      ...
      <section className="py-20 text-center">
        <ShoppingBag className="mx-auto h-12 w-12 text-(--fg-subtle)" strokeWidth={1} aria-hidden />
        <h2 className="mt-4 text-xl font-semibold">No items listed yet</h2>
        <p className="mt-2 text-sm text-(--fg-muted)">Be the first to list something for sale.</p>
