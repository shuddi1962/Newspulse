  ...
  return (
    <main className="mx-auto w-full max-w-screen-2xl px-6 py-10">
      <header className="mb-8 border-b border-(--border-subtle) pb-6">
        ...
        <p className="mt-1 text-sm text-(--fg-muted)">Find properties for sale and rent</p>
      </header>

      <form action="/real-estate" method="GET" className="mb-8">
      ...
      <section className="py-20 text-center">
        <Home className="mx-auto h-12 w-12 text-(--fg-subtle)" strokeWidth={1} aria-hidden />
        <h2 className="mt-4 text-xl font-semibold">No properties listed</h2>
        <p className="mt-2 text-sm text-(--fg-muted)">Properties will appear here once agents and owners list them.</p>
